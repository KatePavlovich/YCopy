...
export default AdvertisingTempate

export const query = graphql`
  query AdvertisingTempate {
    page: markdownRemark(frontmatter: { templateKey: { eq: "Advertising" } }) {
      html
      frontmatter {
        title
        description
