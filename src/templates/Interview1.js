...
const Interview1Template = ({
  data: {
    page: {
      html,
      frontmatter: { title, image, author, photographer, illustrator, lead, biography, seo },
      fields: {
        slug,
        mainTag: {
...
Interview1Template.propTypes = {
  data: PropTypes.shape({
    page: PropTypes.object,
  }),
}

export default Interview1Template

export const query = graphql`
  query Interview1Template($id: String!) {
